            ...
            <div className="card">
              <div className="card-body">
                <div class="container text-center">
                  <div class="row">
                    <div class="col">
                        <img src="https://farms.marathoncash.com/assets/logo-cr.png" alt="" width={140} />
                    </div>
                    <div class="col">
              ...
              <div className="pending">
                <div className="px-5 pendingcolor mb-5">
                   ...
                   <h5 className="fw-bold">Daily Output of <span className="spanfontcolor">MRACE</span></h5>

                </div>
                <div className="px-5 pendingcolor">
                    <h5 className="fw-bold">< span className="spanfontcolor">0.00</span> MRACE</h5>
                    <h5 className="fw-bold">< span className="spanfontcolor">0.00</span> MRACE</h5>
                </div>
              </div>
            </div>
